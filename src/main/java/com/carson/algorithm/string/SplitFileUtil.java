...
public class SplitFileUtil {
    ...
    public static void main(String[] args) {
        ...
        // 目标文件
        String targetFile = "C:\\Users\\Administrator\\Downloads\\logs-from-scm-house-service-in-scm-house-service-7f48b44469-fcqq6.txt";
        // 存放的目录
        String saveDir = "C:\\Users\\Administrator\\Downloads\\logs";
        // 自定义的生成文件前缀名
        String saveFileName = "log";
        // 生成文件格式的后缀
        String suffix = "txt";
        // 自定义 一个文件的行数，这里是 100000 行 一个文件
        long splitSize = 500000;
        try {
